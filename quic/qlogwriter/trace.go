...
import (
	...
	"github.com/kulikov0/headless-client/quic/qlogwriter/jsontext"
)
...
// -ldflags="-X github.com/kulikov0/headless-client/quic/qlogwriter.quicGoVersion=foobar"
...
func init() {
	...
	for _, d := range info.Deps {
		if d.Path == "github.com/kulikov0/headless-client/quic" {
